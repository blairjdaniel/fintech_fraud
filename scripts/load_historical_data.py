...
csv_path = '/Users/blairjdaniel/fintech_fraud/data/bitcoin_historical_data.csv'
...
df.to_sql('bitcoin_historical_data', engine, if_exists='replace', index=False)

print("Data loaded successfully into table: bitcoin_historical_data")